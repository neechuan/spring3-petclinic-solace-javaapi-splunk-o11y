...
/**
 * Creates and connects the Solace {@link MessagingService} used for the request/reply
 * RPC. A plain PubSub+ Messaging API for Java service is configured here (rather than the
 * Spring Boot starter) so the setup stays independent of the Spring Boot version.
 */
@Configuration
